...
const Welcome = () => {
  ...
  useEffect(() => {
    ...
    const fetchRepositoriesFromBackend = async () => {
      try {
  ...
  function handleFetchDependencies() {
    fetchDependencies();
  }
      ...
      <div className="w-screen h-screen flex flex-col items-center gap-12 p-32">
        <div className="w-full xl:w-1/2 flex flex-col gap-4 ">
          ...
          <button
            ...
            className="w-full bg-yellow-500 flex items-center justify-center rounded-xl p-3"
          >
            click here
          </button>
        </div>
